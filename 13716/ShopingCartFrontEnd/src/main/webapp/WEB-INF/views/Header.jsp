...
<body background="<c:url value="/resources/images/backround.jpg" />">
<style>
...
<div class="container">
	<div class="row">
			...
			<figure class="figure">
						...
						<h2 > THIVYA MUSICAL INSTRUMENTS</h2>
						</div>
			</figure>
			</div>
	        ...
	        <div class="col-sm-2">
			<figure class="figure">
						<img src="<c:url value="/resources/images/vector.jpg"/>" class="img-responsive" style="width:100%" alt="Image">
						<div class="carousel-caption">
						<h2 > THIVYA MUSICALS</h2>
						</div>
			</figure>
			</div>
	</div>
